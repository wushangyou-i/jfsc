var Wlen =  $(".ZP .zhuangpan .Zpic").width();
var Whe =  $(".ZP .zhuangpan .Zpic").width();
var turnplate={
		restaraunts:[],				//大转盘奖品名称
		colors:[],					//大转盘奖品区块对应背景颜色
		outsideRadius:Wlen/2,			//大转盘外圆的半径
...
$(document).ready(function(){
	//动态添加大转盘的奖品与奖品区域背景颜色
	turnplate.randomRate = ["50%", '0%', '0%', '50', '0%', '0%',];
	turnplate.restaraunts = ["再接再励", "三等奖", "幸运奖", "二等奖", "谢谢参与", "一等奖", ];
//	"20猫币 ", "30元免费流量包", "100元免费流量包", "2猫币"
